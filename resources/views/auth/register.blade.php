            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="hak_akses" class="col-md-4 col-form-label text-md-right">Jenis Akun</label>
                        ...
                        <div class="form-group row">
                            <label for="file" class="col-md-4 col-form-label text-md-right">Foto Profil</label>
